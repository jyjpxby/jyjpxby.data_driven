...
A=load('TDEBD.txt');%The third column of the file can be replaced by columns C, D and E of the Co3O4, CuCo2O4, MnCo2O4 and MnCuCo7O12 worksheets in Table S3 Reaction energy.xlsx
x=A(:,1);y=A(:,2);z=A(:,3);
W=load('TDEBD_P.txt');
